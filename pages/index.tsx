    ...
    <header className="flex flex-col items-start justify-center px-6 py-12 md:py-16 max-w-5xl mx-auto">
      ...
      <section className="px-6 py-16 md:py-8 bg-gray-50">
        <div className="max-w-5xl mx-auto text-left">
          ...
          <p className="text-lg max-w-3xl text-gray-600">
                ...
                where we learned about the AI workflows and levels of oversight, and co-designed diagrams of the AI workflows.          </p>
        </div>
      </section>
      ...
      <section className="px-6 py-16 md:py-8 bg-gray-50">
        <div className="max-w-5xl mx-auto text-left">
          ...
          <p className="text-lg max-w-3xl text-gray-600">
                Research Paper [<a href="https://ojs.aaai.org/index.php/AIES/article/view/36636" className="text-blue-600 underline hover:text-blue-800">AAAI/ACM AIES '25 Paper</a>] [<a href="https://arxiv.org/abs/2508.14119" className="text-blue-600 underline hover:text-blue-800">arXiv version with Repository</a>]<br />
